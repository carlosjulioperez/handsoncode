...
class FosfatosSaveAction extends ViewBaseAction implements IChainAction{
    ...
    void execute() throws Exception{
        ...
        MapFacade.setValues("Fosfatos",
            getView().getKeyValues(), getView().getValues()
        )

        Fosfatos fosfatos = XPersistence.getManager().find( Fosfatos.class, getView().getValue("id") )
        fosfatos.save()
        //getView().refresh()
