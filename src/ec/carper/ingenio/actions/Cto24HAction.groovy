...
class Cto24HAction extends OnChangePropertyBaseAction{
    ...
    void execute() throws Exception{
        ...
        if (diaTrabajoId)
            getView().setValue("ccJ14", SqlUtil.instance.getValorCampo(diaTrabajoId, "Jugo", "jeBri"))
        if (ccJ12 && ccJ13)
        ...
        if (diaTrabajoId)
            getView().setValue("ccJd4", SqlUtil.instance.getValorCampo(diaTrabajoId, "Jugo", "jdBri"))
        if (ccJd2 && ccJd3)
        ...
        if (diaTrabajoId)
            getView().setValue("ccJc4", SqlUtil.instance.getValorCampo(diaTrabajoId, "Jugo", "jcBri"))
        if (ccJc2 && ccJc3)
        ...
        if (diaTrabajoId)
            getView().setValue("ccJf4", SqlUtil.instance.getValorCampo(diaTrabajoId, "Jugo", "jfBri"))
        if (ccJf2 && ccJf3)
        ...
        if (diaTrabajoId)
            getView().setValue("ccMc4", SqlUtil.instance.getValorCampo(diaTrabajoId, "Meladura", "mclBri2"))
        if (ccMc2 && ccMc3)
        ...
        if (diaTrabajoId)
            getView().setValue("ccMa4", SqlUtil.instance.getValorCampo(diaTrabajoId, "Mieles", "maBri2"))
        if (ccMa2 && ccMa3)
        ...
        if (diaTrabajoId)
            getView().setValue("ccMb4", SqlUtil.instance.getValorCampo(diaTrabajoId, "Mieles", "mbBri2"))
        if (ccMb2 && ccMb3)
        ...
        if (diaTrabajoId)
            getView().setValue("ccMf4", SqlUtil.instance.getValorCampo(diaTrabajoId, "Mieles", "mfBri2"))
        if (ccMf2 && ccMf3)
