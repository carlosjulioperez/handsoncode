...
class StockFabricaTest extends ModuleTestBase {
    ...
    void testCrear() throws Exception {
        ...
        assertValueInCollection("detalle1" , 3 , 2, "6.424") 
        ...
        assertValueInCollection("detalle2" ,  6 , 2, "1.307") 
        assertValueInCollection("detalle2" ,  7 , 2, "11.227") 
        ...
        execute("Collection.save")
        assertNoErrors()
        assertValueInCollection("detalle5" ,  0 , 2, "129.645") 
        ...
        assertValueInCollection("detalle6" ,   1 , 2, "4.250") 
        assertValueInCollection("detalle6" ,   2 , 2, "20.862") 
        assertValueInCollection("detalle6" ,   3 , 2, "0.200") 
        assertValueInCollection("detalle6" ,   4 , 2, "0.250") 
        assertValueInCollection("detalle6" ,   5 , 2, "0.444") 
        assertValueInCollection("detalle6" ,   6 , 2, "12.784") 
        assertValueInCollection("detalle6" ,   7 , 2, "15.320") 
        assertValueInCollection("detalle6" ,   8 , 2, "13.210") 
        assertValueInCollection("detalle6" ,   9 , 2, "1.790") 
        ...
        assertValueInCollection("detalle7" ,   2 , 2, "3.004") 
        assertValueInCollection("detalle7" ,   3 , 2, "0.210") 
        assertValueInCollection("detalle7" ,   4 , 2, "0.500") 
        assertValueInCollection("detalle7" ,   5 , 2, "0.342") 
        ...
        assertValueInCollection("detalle8" ,  2 , 2, "7.789") 
        ...
        assertValueInCollection("detalle9" ,  2 , 2, "5.723") 
        ...
        assertValueInCollection("detalle10" ,  2 , 2, "5.723") 
        ...
        assertValueInCollection("detalle12" ,  2 , 2, "5.723") 
        ...
        assertValueInCollection("detalle24" ,  1 , 2, "17.462") 
        ...
        assertValueInCollection("detalle26" ,  1 , 2, "14.894") 
        ...
        assertValueInCollection("detalle28" ,  1 , 2, "23.369") 
        ...
        execute("Collection.save")
        assertNoErrors()
        assertValueInCollection("detalle33" ,  0 , 2, "4.488") 
        ...
        execute("Collection.save")
        assertNoErrors()
        assertValueInCollection("detalle34" ,  0 , 2, "5.712") 
        ...
        execute("Collection.save")
        assertNoErrors()
        assertValueInCollection("detalle35" ,  0 , 2, "2.856") 
        ...
        execute("Collection.save")
        assertNoErrors()
        assertValueInCollection("detalle36" ,  0 , 2, "13.464") 
        ...
        assertValueInCollection("detalle42" ,  2 , 2, "3.142") 
        ...
        assertValueInCollection("detalle44" ,  4 , 2, "0.820") 
        assertValueInCollection("detalle44" ,  5 , 2, "4.753") 
        assertValueInCollection("detalle44" ,  6 , 2, "6.448") 
        assertValueInCollection("detalle44" ,  7 , 2, "91.340") 
        assertValueInCollection("detalle44" ,  8 , 2, "87.180") 
        assertValueInCollection("detalle44" ,  9 , 2, "8.370") 
        ...
        execute("Collection.save")
        assertNoErrors()
        assertValueInCollection("detalle53" ,  0 , 2, "0.336")
        ...
        execute("Collection.save")
        assertNoErrors()
        assertValueInCollection("detalle55" ,  0 , 2, "1.048")
        ...
        assertValueInCollection("detalle65" ,  2 , 2, "102.022")
        ...
        assertValueInCollection("detalle70" ,  2 , 2, "88.358")
        ...
        assertValueInCollection("detalle71" ,  2 , 2, "84.823")
        ...
        assertValueInCollection("detalle71" ,  8 , 2, "123.350")
        ...
        assertValueInCollection("detalle72" ,  1 , 2, "1.790")
        ...
        assertValueInCollection("detalle72" ,  5 , 2, "11.950")
        assertValueInCollection("detalle72" ,  6 , 2, "57.560")
        assertValueInCollection("detalle72" ,  7 , 2, "60.220")
        assertValueInCollection("detalle72" ,  8 , 2, "3.670")
        assertValueInCollection("detalle72" ,  9 , 2, "145.100")
        ...
        assertValueInCollection("detalle72" , 15 , 2, "251.840")

        execute("Sections.change", "activeSection=1,viewObject=xava_view_section23")
        assertCollectionRowCount("detalle73", 18)
        ...
        execute("StockFabrica.editDetail" , "row=4,viewObject=xava_view_section23_section1_detalle73")
        assertDialog()
        setValue    ( "valor" , "10.5")
        execute("Collection.save")
        assertNoErrors()
        ...
        assertValueInCollection("detalle73" ,  7 , 2, "65.653")
        assertValueInCollection("detalle73" ,  8 , 2, "52.149")
        assertValueInCollection("detalle73" ,  9 , 2, "79.431")
        assertValueInCollection("detalle73" , 10 , 2, "1,320.220")
        assertValueInCollection("detalle73" , 11 , 2, "624.172")
        assertValueInCollection("detalle73" , 12 , 2, "495.788")
        assertValueInCollection("detalle73" , 13 , 2, "262.761")
        assertValueInCollection("detalle73" , 14 , 2, "1,302.738")
        assertValueInCollection("detalle73" , 15 , 2, "1,306.527")
        assertValueInCollection("detalle73" , 16 , 2, "-806.950")
        assertValueInCollection("detalle73" , 17 , 2, "-791.127")
