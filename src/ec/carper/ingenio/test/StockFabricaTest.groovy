...
class StockFabricaTest extends ModuleTestBase {
    ...
    void testCrear() throws Exception {
        ...
        assertValueInCollection("detalle73" ,  4 , 2, "500.160")
        assertValueInCollection("detalle73" ,  5 , 2, "950.714")
        ...
        assertValueInCollection("detalle73" , 10 , 2, "624.172")
        assertValueInCollection("detalle73" , 11 , 2, "495.788")
        assertValueInCollection("detalle73" , 12 , 2, "262.761")
        assertValueInCollection("detalle73" , 13 , 2, "1,302.738")
        assertValueInCollection("detalle73" , 14 , 2, "1,306.527")
        assertValueInCollection("detalle73" , 15 , 2, "-806.950")
        assertValueInCollection("detalle73" , 16 , 2, "-791.127")
