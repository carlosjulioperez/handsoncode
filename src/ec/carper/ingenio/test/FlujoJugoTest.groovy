...
class FlujoJugoTest extends ModuleTestBase {
    ...
    void testCrear() throws Exception {
        ...
        setValue    ( "horaSBrixJDil" , "07:00")
        assertValue ( "horaBrixJDil"  , "07/08/2019 07:00")
        ...
        execute('Collection.new' , 'viewObject=xava_view_section0_detalle')
        assertDialog()
        setValue    ( "horaS"         , "02:30")
        assertValue ( "hora"          , "08/08/2019 02:30")
        setValue    ( "ini"           , "2406")
        setValue    ( "fin"           , "2424")
        assertValue ( "tot"           , "18")
        setValue    ( "horaSBrixJDil" , "18:00")
        ...
        assertValue ( "brixJDil"      , "0.00")
        assertValue ( "p"             , "998.203")
        assertValue ( "tonJugo"       , "17.967654")
        execute("Collection.save")

        execute('Collection.new' , 'viewObject=xava_view_section0_detalle')
        assertDialog()
        setValue    ( "horaS"         , "03:30")
        assertValue ( "hora"          , "08/08/2019 03:30")
        setValue    ( "ini"           , "2424")
        setValue    ( "fin"           , "2442")
        assertValue ( "tot"           , "18")
        setValue    ( "horaSBrixJDil" , "18:00")
        ...
        setValue    ( "fin"           , "2459")
        assertValue ( "tot"           , "17")
        setValue    ( "horaSBrixJDil" , "20:00")
        assertValue ( "horaBrixJDil"  , "07/08/2019 20:00")
        assertValue ( "brixJDil"      , "13.36")
        assertValue ( "p"             , "1,051.921")
        assertValue ( "tonJugo"       , "17.882657")
        execute("Collection.save")

        execute('Collection.new' , 'viewObject=xava_view_section0_detalle')
        assertDialog()
        setValue    ( "horaS"         , "05:30")
        assertValue ( "hora"          , "08/08/2019 05:30")
        setValue    ( "ini"           , "2459")
        setValue    ( "fin"           , "2476")
        assertValue ( "tot"           , "17")
        setValue    ( "horaSBrixJDil" , "20:00")
        ...
        execute('Collection.new' , 'viewObject=xava_view_section0_detalle')
        assertDialog()
        setValue    ( "horaS"         , "06:30")
        assertValue ( "hora"          , "08/08/2019 06:30")
        setValue    ( "ini"           , "2476")
        setValue    ( "fin"           , "2493")
        assertValue ( "tot"           , "17")
        setValue    ( "horaSBrixJDil" , "20:00")
